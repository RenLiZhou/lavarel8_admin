    ...
    <div class="or-mid">
        <form class="layui-form layui-form-pane" style="width:95%;">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input" name="mobile" value="{{ $admin->mobile }}" placeholder="请输入手机号">
                </div>
            </div>
            @permission('admin.admin.update')
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn" lay-submit lay-filter="update-user" data-url="{{ route('admin.admin.update', ['admin' => $admin->id]) }}" data-type="PUT">立即提交</button>
