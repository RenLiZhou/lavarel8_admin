...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin_static/login/login.css') }}">
...
<body>
<img class="bgpic" src="{{ asset('admin_static/login/bg.png') }}">
<div class="login">
    <h1>LyAdmin-后台登录</h1>
...
<script>
    layui.config({base: '/admin_static/base/'}).use(['form', 'ori'],function(){
        var form = layui.form,
            $ = layui.jquery,
            dialog = layui.dialog,
            ori = layui.ori;
