    ...
    <div class="or-mid">
        <form class="layui-form layui-form-pane"  style="width:95%;">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input" name="href" placeholder="请输入链接(权限菜单)">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input" name="icon" placeholder="请输入路由别名(一级菜单)">
                </div>
            </div>
            @permission('admin.rule.store')
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn" lay-submit lay-filter="create-rule" data-url="{{ route('admin.rule.store') }}" data-type="POST">立即提交</button>
