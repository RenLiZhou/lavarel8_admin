    ...
    <div class="or-mid">
        <form class="layui-form layui-form-pane"  style="width:95%;">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input" name="href" value="{{ $curRule->href }}" placeholder="请输入链接(权限菜单)">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input" name="icon" value="{{ $curRule->icon }}" placeholder="请输入路由别名(一级菜单)">
                </div>
            </div>
            @permission('admin.rule.update')
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn" lay-submit lay-filter="edit-rule" data-url="{{ route('admin.rule.update', ['rule' => $curRule->id]) }}" data-type="PUT">立即提交</button>
